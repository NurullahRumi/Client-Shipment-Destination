...
public class VRft90201Controller {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VRft90201 getVRft90201(@RequestParam("approle") String approle, @RequestParam("appid") String appid, @RequestParam("userid") String userid, @RequestParam("rolename") String rolename) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public VRft90201 editVRft90201(@RequestParam("approle") String approle, @RequestParam("appid") String appid, @RequestParam("userid") String userid, @RequestParam("rolename") String rolename, @RequestBody VRft90201 vrft90201) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteVRft90201(@RequestParam("approle") String approle, @RequestParam("appid") String appid, @RequestParam("userid") String userid, @RequestParam("rolename") String rolename) {
    ...
    public Page<VRft90201> searchVRft90201sByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering VRft90201s list by query filter:{}", (Object) queryFilters);
    ...
    public Page<VRft90201> findVRft90201s(@ApiParam("conditions to filter the results") @RequestParam(value = "q", required = false) String query, Pageable pageable) {
        LOGGER.debug("Rendering VRft90201s list by filter:", query);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StringWrapper exportVRft90201sAndGetURL(@RequestBody DataExportOptions exportOptions, Pageable pageable) {
        String exportedFileName = exportOptions.getFileName();
        if(exportedFileName == null || exportedFileName.isEmpty()) {
            exportedFileName = VRft90201.class.getSimpleName();
        }
        exportedFileName += exportOptions.getExportType().getExtension();
        String exportedUrl = exportedFileManager.registerAndGetURL(exportedFileName, outputStream -> vRft90201Service.export(exportOptions, pageable, outputStream));
